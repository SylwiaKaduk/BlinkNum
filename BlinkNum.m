function BN=BlinkNum(a)
%UNTITLED Function checks the blink column in EOG detects whenever the
...
%rows in the matrix
%   for each row checking if the cell in the blink column is different or
